...
class SplitEventTypeTest
{
    ...
    {
        @Test
        @DisplayName("Splits CUD into compound and elementary families")
        void splitCud()
        {
        ...
        @Test
        @DisplayName("Splits transit into update")
        void splitTransit()
        {
        ...
        @Test
        @DisplayName("Splits create into combined and port by default")
        void splitCreateByDefault()
        {
        ...
        @Test
        @DisplayName("Skips create to compound split when disabled")
        void skipCreateToCompound()
        {
            String entity = new String("created");
            Create<String> event = new Create<>(entity);
            Set<Event<String>> events = new LinkedHashSet<>();
        ...
        @Test
        @DisplayName("Splits port update branch with update and combined families")
