...
class RuntimeKeyTest
{
    ...
    {
        @Test
        @DisplayName("Uses identity for equality")
        void identityForEquality()
        {
    ...
    {
        @Test
        @DisplayName("Requires key and entity")
        void requiresKeyAndEntity()
        {
            ...
            IllegalStateException entityError =
