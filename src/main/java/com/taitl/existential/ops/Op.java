...
public class Op
{
     ...
     */
    public ConfigBuilder context(String name)
    {
        return new ConfigBuilder(this, name, ConfigBuilder.TargetType.TYPE_CONTEXT);
    }
     ...
     */
    public ConfigBuilder transaction(String name)
    {
        return new ConfigBuilder(this, name, ConfigBuilder.TargetType.TYPE_TRANSACTION);
    }
     ...
     */
    protected void addContext(Context cont)
    {
        Args.cool(cont, "cont");
