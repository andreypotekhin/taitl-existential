...
public class ContextKey extends AbstractPath
{
    ...
    // Args.require(name.length() == 1 || !name.endsWith(SLASH), "Argument 'name' should not end
    // with a slash ('/')");
    // }
    //
    // /**
    // * Gets this key parent key, if any - a shortened key without the part starting with the last
    // slash.
