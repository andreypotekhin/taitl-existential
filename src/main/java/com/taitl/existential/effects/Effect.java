...
public class Effect<T> implements Evs<T>, Immediate<T>
{
    ...
    {
        Args.sane(condition, "condition", action, "action");
    ...
    {
        Args.sane(condition, "condition", action, "action", description, "description");
        return add(new On<T>(condition, action));
    }
    ...
    {
        Args.sane(action, "action", description, "description");
