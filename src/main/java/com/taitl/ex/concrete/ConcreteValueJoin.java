...
/**
 * Backing implementation for {@link ValueJoin}.
 */
public class ConcreteValueJoin<V, W, K>
{
    ...
    public ConcreteValueJoin(Function<V, K> getLeftKey, Function<W, K> getRightKey)
    {
