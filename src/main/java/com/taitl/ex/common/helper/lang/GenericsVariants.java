package com.taitl.ex.common.helper.lang;

import java.util.*;

import static com.taitl.ex.common.helper.Args.*;

public class GenericsVariants
{
    public List<String> call(String key)
    {
        sane(key, "key");
        return variants(parse(key));
    }
    ...
    protected void combinations(String root, List<List<String>> perArg, int i, List<String> current, List<String> out)
    {
        if (i == perArg.size())
        {
