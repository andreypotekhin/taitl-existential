...
Plan a cleanup for the deprecated `com.taitl.ex.logic.unused` package: decide whether to remove it, relocate it to a
legacy module, or wrap it behind a clear compatibility boundary. Include a migration note in Readme/Troubleshooting so
consumers know how to move to `EventKey`.
